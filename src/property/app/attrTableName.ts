import { Meta, ForSchema, OfSchema, SchemaType, Property, SCHEMA_KIND_PROPERTY, PropertyValueType, NS_SYSTEM_IDENTIFIER, buildFuncCall, Call, NS_SYSTEM_INTRINSIC, Relation, Visible } from "schema-node-core";
