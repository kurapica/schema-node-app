import { NodeType, ValueType, FunctionType, IProperty, getPropertiesBySchemaKind, getNodeType, Meta, ForSchema, OfSchema, SCHEMA_KIND_PROPERTY, SchemaType, NS_SYSTEM_SCHEMA_PROPERTY_CORE, PropertyValueType, NS_SYSTEM_SCHEMA_FUNC_TYPE, Property } from "schema-node-core";
import { EventSchema, EventProperty } from "../../schema/type/eventSchema";
...
export class EventType extends NodeType {
  ...
  override loadProperties(): IProperty[] {
    this._eventSchema = this.getProperty(EventProperty)?.getValue();
